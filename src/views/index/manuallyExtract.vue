	...
	<div class="extract-box">
		<div v-if="!isSendSuccess">
			<el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="190px" size="small" label-position="left" class="demo-ruleForm">
				...
				<el-form-item style="text-align: right"><el-button style="width: 120px;" type="primary" @click="extract('ruleForm')">我要提取</el-button></el-form-item>
			</el-form>
		</div>
		<div v-else class="message-box">
			...
			<el-form :model="sendForm" ref="sendForm" :rules="sendRules" size="small" label-position="left" class="send-success">
				<el-form-item prop="email" style="width: 40%;"><el-input v-model="sendForm.email" placeholder="请把提取码发送至这个邮箱"></el-input></el-form-item>
				<el-form-item><el-button style="width: 120px;" type="primary" @click="submitForm('sendForm')">发送</el-button></el-form-item>
			</el-form>
		</div>
	</div>
</template>
...
import { sendExtractEmail, byExtractGetEmail } from '@/api/index.js';
export default {
	components: {
		[Form.name]: Form,
