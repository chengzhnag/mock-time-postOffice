<template>
	<div class="index-box">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="190px" size="small" label-position="left" class="demo-ruleForm">
			<el-form-item label="你的姓名" prop="name"><el-input v-model="ruleForm.name" placeholder="请填写姓名, 将在邮件的标题中出现"></el-input></el-form-item>
...
<script>
import { Form, FormItem, DatePicker, TimePicker, Col, Checkbox } from 'element-ui';
